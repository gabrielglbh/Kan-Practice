...
class Migrations {
  Future<void> version15to16(Database db) async {
    ...
    await db.rawQuery("ALTER TABLE ${TestDataTableFields.testDataTable} "
        "ADD COLUMN ${TestDataTableFields.testTotalSecondsPerWordListeningField} INTEGER NOT NULL DEFAULT 0");
    await db.rawQuery("ALTER TABLE ${TestDataTableFields.testDataTable} "
        "ADD COLUMN ${TestDataTableFields.testTotalSecondsPerWordSpeakingField} INTEGER NOT NULL DEFAULT 0");
    await db.rawQuery("ALTER TABLE ${TestDataTableFields.testDataTable} "
        "ADD COLUMN ${TestDataTableFields.testTotalSecondsPerPointDefinitionField} INTEGER NOT NULL DEFAULT 0");
    await db.rawQuery("ALTER TABLE ${TestDataTableFields.testDataTable} "
        "ADD COLUMN ${TestDataTableFields.testTotalSecondsPerPointGrammarPointField} INTEGER NOT NULL DEFAULT 0");
  }

  // Reverts to version 13: Remove translation tests from existence
  Future<void> version14to15(Database db) async {
    await db.transaction((txn) async {
      ...
      await txn.execute("CREATE TABLE TEMP2("
      ...
      await txn.execute("INSERT INTO "
          "TEMP2(${AlterTestSpecificDataTableFields.idField}, "
          "${AlterTestSpecificDataTableFields.totalNumberTestCountField}, "
          "${AlterTestSpecificDataTableFields.totalWinRateNumberTestField}) "
          "SELECT "
          "${AlterTestSpecificDataTableFields.idField}, "
          "${AlterTestSpecificDataTableFields.totalNumberTestCountField}, "
          "${AlterTestSpecificDataTableFields.totalWinRateNumberTestField} "
          "FROM ${AlterTestSpecificDataTableFields.testDataTable}");
      await txn.execute(
          "DROP TABLE ${AlterTestSpecificDataTableFields.testDataTable}");
      await txn.execute(
          "ALTER TABLE TEMP2 RENAME TO ${AlterTestSpecificDataTableFields.testDataTable}");
    });
  }
