...
class KPWordGrammarBottomNavigation extends StatelessWidget {
        ...
        child: Row(
          ...
          children: List.generate(
            ...
            (index) => _bottomBarItem(
                context, ListDetailsType.values[index], constraints.maxWidth),
          ),
        ),
      );
    });
  ...
  Widget _bottomBarItem(
      BuildContext context, ListDetailsType type, double width) {
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: Container(
          width: width / ListDetailsType.values.length,
          height: 42,
