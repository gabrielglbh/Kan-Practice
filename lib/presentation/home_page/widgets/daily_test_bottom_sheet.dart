...
class DailyBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BottomSheet(
      ...
      builder: (context) {
        return BlocProvider(
          create: (context) => getIt<LoadTestDailyBloc>(),
          child: BlocConsumer<LoadTestDailyBloc, LoadTestDailyState>(
            listener: (context, state) async {
              if (state is LoadTestDailyStateLoadedList) {
                ...
                final name =
                    "${"abbr_test_mode_daily".tr()}: $today$folderTitle";
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                          "${"daily_test_bottom_sheet_title".tr()}$title",
