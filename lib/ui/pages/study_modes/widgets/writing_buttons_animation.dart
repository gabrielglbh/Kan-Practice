...
class WritingButtonsAnimations extends StatelessWidget {
  ...
  Widget _submit() {
    return Container(
      key: ValueKey<int>(id),
      child: _animation(side: triggerSlide, child: KPActionButton(
  ...
  Row _validation() {
    return Row(
      ...
      children: [
        Expanded(
          flex: 1,
          child: _animation(duration: 1, child: KPActionButton(
        ...
        Expanded(
          flex: 1,
          child: _animation(duration: 2, child: KPActionButton(
        ...
        Expanded(
          flex: 1,
          child: _animation(duration: 3, child: KPActionButton(
        ...
        Expanded(
          flex: 1,
          child: _animation(duration: 4, child: KPActionButton(
